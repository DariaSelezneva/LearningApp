...
struct Person {
    ...
    static let eccleston = Person(id: 0, name: "Doctor", image: UIImage(named: "eccleston"), position: "9th", isOnline: true)
    static let tennant = Person(id: 1, name: "Doctor", image: UIImage(named: "tennant"), position: "10th", isOnline: true)
    static let smith = Person(id: 2, name: "Doctor", image: UIImage(named: "smith"), position: "11th", isOnline: true)
    ...
    static let strax = Person(id: 7, name: "Strax Sontaranian", image: UIImage(named: "strax"), position: "Sontaranian warrior", isOnline: true)
